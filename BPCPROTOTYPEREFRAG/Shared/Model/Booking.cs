...
namespace BPCPROTOTYPEREFRAG.Shared.Model
{
    public class Booking
    {
        ...
        {
            return $"{nameof(OrderNo)}: {OrderNo}, {nameof(Status)}: {Status}, {nameof(CompanyCvrNo)}: {CompanyCvrNo}, {nameof(NumOfCarsNeeded)}: {NumOfCarsNeeded}, {nameof(Comment)}: {Comment}, {nameof(TypeOfGoods)}: {TypeOfGoods}, {nameof(TotalWidth)}: {TotalWidth}, {nameof(TotalLength)}: {TotalLength}, {nameof(TotalHeight)}: {TotalHeight}, {nameof(TotalWeight)}: {TotalWeight}, {nameof(StartDate)}: {StartDate}, {nameof(StartAddress)}: {StartAddress}, {nameof(StartPostalCode)}: {StartPostalCode}, {nameof(StartCity)}: {StartCity}, {nameof(StartCountry)}: {StartCountry}, {nameof(EndDate)}: {EndDate}, {nameof(EndAddress)}: {EndAddress}, {nameof(EndPostalCode)}: {EndPostalCode}, {nameof(EndCity)}: {EndCity}, {nameof(EndCountry)}: {EndCountry}, {nameof(TruckDriverId)}: {TruckDriverId}, {nameof(ContactPerson)}: {ContactPerson}";
        }
